        ...
        <div class="container cat-strip">
            <div class="cat-grid">
                <?php foreach ($categories as $category) : ?>
                    <a href="<?= BASE_URL ?>?act=category&amp;slug=<?= urlencode($category['slug']) ?>" class="cat-card">
    ...
    <div class="container">
        ...
        <?php if (!empty($featuredProducts)) : ?>
            <div class="section">
                <div class="section-head">
                    ...
                    <a href="<?= BASE_URL ?>?act=products&amp;featured=1" class="see-all">
                        Xem tất cả
                ...
                <div class="product-grid">
                    ...
                    ?>
                        <a href="<?= BASE_URL ?>?act=product-detail&amp;slug=<?= urlencode($product['slug']) ?>" class="product-card">
        ...
        <div class="section pb-5">
            <div class="section-head">
                ...
                <a href="<?= BASE_URL ?>?act=products&amp;sort=newest" class="see-all">
                    Xem tất cả
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg>
                </a>
            </div>
            ...
            <?php if (!empty($top5ProductLatest)) : ?>
                <div class="latest-container">
                    ...
                    ?>
                        <a href="<?= BASE_URL ?>?act=product-detail&amp;slug=<?= urlencode($product['slug']) ?>" class="latest-row">
