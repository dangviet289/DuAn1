...
<body>
    <div class="shell">
        ...
        <main class="main">
            <div class="topbar">
                <div>
                    <div class="eyebrow">Quản trị banner</div>
                    <h1>Thêm banner mới</h1>
                    <p>Thêm banner hiển thị trên trang chủ với hình ảnh, link và thứ tự.</p>
                </div>
            ...
            <div class="form-card">
                ...
                <form method="POST" action="<?= BASE_URL_ADMIN ?>banners.php?act=store">
                    <div class="row g-4">
                        <div class="col-lg-8">
                            <label class="form-label">URL ảnh banner <span class="text-danger">*</span></label>
                            <input type="text" name="image" id="imageUrl" class="form-control" required placeholder="https://...">
                        </div>
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="text" name="title" class="form-control" placeholder="Khuyến mãi mùa hè...">
                        </div>
                        <div class="col-lg-6">
                            <label class="form-label">Link</label>
                            <input type="text" name="link" class="form-control" placeholder="?act=product-detail&amp;slug=...">
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            <div>
                                ...
                                <img id="previewImage" class="img-preview" src="" alt="Preview banner" style="display:none;">
                            </div>
                        </div>
                    </div>
